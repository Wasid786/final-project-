    ...
    <div className="footer-section">
      <div className="footer-container">
        ...
        <div className="ft-list" id="contact">
          ...
          <ul className="ft-list-items">
            ...
            <li>
              <a href="tel:+91 8630633575">+91 9389746454</a>
            </li>
            <li>
              <a href="tel:+91 8445315542">+91 8439140274</a>
            </li>
          </ul>
        </div>
      </div>
      ...
      <div className="ft-copyright">
        ...
        <ul className="ft-social-links">
          <li>
            <a
              href="https://www.linkedin.com/in/wasid-ansari-57ab75229/"
              title="LinkedIn"
              target="_blank"
          ...
          <li>
            <a
              href="https://www.facebook.com/profile.php?id=100085622973359"
              title="FaceBook"
              target="_blank"
              rel="noopener noreferrer"
            >
          ...
          <li>
            <a
              href="https://twitter.com/Wasid_ansari_1"
              title="Twitter"
              target="_blank"
              rel="noopener noreferrer"
            >
        ...
        <p className="">© 2024-2030  All rights reserved by Wasid  </p>
      </div>
    </div>
  );
}
